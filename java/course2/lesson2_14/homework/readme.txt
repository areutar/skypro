От вас требуется написать свою реализацию ArrayList.

Для упрощения, он должен работать только со строками.
...
Напишите реализацию этого интерфейса, реализовав все его методы.
